    ...
    <main className="relative min-h-[calc(100vh-4rem)] overflow-hidden pb-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 pt-12 sm:px-6 lg:px-8 lg:pt-16">
        ...
        <header className="mt-8 text-center sm:mt-10">
          <p className="font-mono text-xs font-medium uppercase tracking-widest text-slate-500">Омӯзиш</p>
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Курсҳо</h1>
          <p className="mx-auto mt-4 max-w-xl text-pretty text-base text-slate-400 sm:text-lg">
